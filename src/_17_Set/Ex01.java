...
public class Ex01 {
    ...
    olan arry elemanlari sete convert eden  bir method create ediniz .
    ...
    public static void main(String[] args) {
        ...
        elemanEkle(hs,arr);
        System.out.println("\n***");
        elemanEkle(hs,new int[]{34,35,45,61,38,41});


    }

    private static void elemanEkle(HashSet<Integer> hs, int[] arr) {
