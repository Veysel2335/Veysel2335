...
public class Ter03 {
    ...
    public static void main(String[] args) {
        ...
        String sonuc=(sayi>99&&sayi<1000) ?("3 basamakli sayi") :(sayi%2==0  ?  "3 basamakli olmayan cift sayi":"3 basamaklı olmayan tek sayı");
        System.out.println(sonuc);//ne kadar  ? o kadar: aksi halde hata verecektir
