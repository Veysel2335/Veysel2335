...
*/
    public static void main(String[] args) {
        ...
        if (num1 >= num2 && num1 >= num3) {
            System.out.println(num1 + " en buyuk sayidir"); //en büyük 1 2 ve 3?
            ...
            System.out.println(num2 + " en buyuk sayidir");//en büyük 2
            ...
            System.out.println(num3 + " en buyuk sayidir");//en büyük 2
