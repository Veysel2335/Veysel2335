...
*/
    public static void main(String[] args) {
        ...
        while (i<=sayi){
            ...
            i++;//bunu yapmazsan sonsuza girer

        }
        System.out.println();
        System.out.println("sayinin poz carpanlarininin sayisi:"+sayac);
        System.out.println("sayinin neg carpanlarininin sayisi:"+sayac);
        System.out.println("sayinin tum carpanlarininin sayisi:"+2*sayac);
    }
}